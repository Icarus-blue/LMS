...
{
    protected $loc, $my_class, $user, $student, $teacher_repo,$message_repo;
   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student, TeacherRepo $teacher_repo, MessageRepo $message_repo)
   {
    ...
    public function clear_field(){
        ...
        return view('pages.support_team.students.index2', $data);
    }
    ...
    public function store(Request $req)
    {
        ...
        $model['email'] = substr($req->full_name,0,7)."strain@bibirionihigh";
    ...
    public function mystudents(Request $req){
        // return json_encode(['ok'=>$req->my_class_id]);
        $students = $this->student->findStudentsByClass2($req->my_class_id);
    ...
    public function fileImport2(Request $request) {
        ...
        return json_encode(['res'=>'Uploaded  Successfully']);
    }
