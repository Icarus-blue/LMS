...
<div class="card">
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight cardpos" style=" transform:translateX(-22px);">
            ...
            <li class="nav-item"><a href="#view_inbox" class="nav-link active" data-toggle="tab"><i
                        class="icon-envelope"></i> View Inbox</a></li>
            @else
            <li class="nav-item"><a href="#view_inbox" class="nav-link active" data-toggle="tab"><i
                        class="icon-envelope"></i> View Inbox</a></li>
            <li class="nav-item"><a href="#compose_message" class="nav-link" data-toggle="tab"><i
                        class="icon-pencil"></i>Compose Message</a></li>
        ...
        <div class="tab-content tabpos">
            <div class="tab-pane fade show active" id="view_inbox">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {{ $key + 1 }}</td>
                            <td><a href="{{ route('messages.show', $message->id)}}">asdfasd </a>
                            </td>
            ...
            <div class="tab-pane fade" id="compose_message">
                ...
                <form method="POST" action="{{ route('messages.store') }}">
                    @csrf
                    <h5><span class="badge badge-primary rounded-circle text-center" id="message-first-badge">1</span>
                        &nbsp; Receivents: <span class="text-primary" id="receiver_type_text"> Students </span></h5>
                    <div class="row mt-3 ml-3" id="message-first-body">
                        <div style="margin-left:-10px;border-left: 1px solid grey; height:100px"></div>
                        <div class="col-md-2">
                            <div class="d-flex">
                                <input type="radio" name="receiver_type" id="Student_Receiver" class="form-control"
                                    checked value="Students" style="width: 20px; height: 20px;">
                        ...
                        <div class="row" style="margin-top: -60px">
                            <div class="text-left mt-3 ml-3">
                                <button type="button" class="btn btn-primary" id="set-message-receiver-type-btn">Next<i
                    ...
                    <br><br>
                    <h5 class="active-font-state" id="message-second-title"> <span
                            class="badge active-badge-state rounded-circle text-center"
                            id="message-second-badge">2</span> &nbsp; Message Type</h5>
                    <div class="row mt-3 ml-3 active-state" id="message-second-body-students">
                        <div style="margin-left:-10px;border-left: 1px solid grey; height:100px"></div>
                        <div class="col-md-3">
                            <div class="d-flex">
                                <input type="checkbox" name="All_Students_Message" id="All_Students_Message"
                                    class="form-control" value="All Students" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="All_Students_Message">All Students</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex">
                                <input type="checkbox" name="Specific_Students_Message" id="Specific_Students_Message"
                                    class="form-control" value="Specific Students" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="Specific_Students_Message">Specific Students</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex">
                                <input type="checkbox" name="Specific_Classes_Message" id="Specific_Classes_Message"
                                    class="form-control" value="Specific Classes" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="Specific_Classes_Message">Specific Classes</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex">
                                <input type="checkbox" name="Exam_Results_Message" id="Exam_Results_Message"
                                    class="form-control" value="Exam Results" style="width: 20px; height: 20px;">
                    ...
                    <div class="row mt-3 ml-3 active-state" id="message-second-body-teachers">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="All_Teachers_Message" id="All_Teachers_Message"
                                    class="form-control" value="All Teachers" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="All_Teachers_Message">All Teachers</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="Specific_Teachers_Message" id="Specific_Teachers_Message"
                                    class="form-control" value="Specific Teachers" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="Specific_Teachers_Message">Specific Teachers</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="Teachers_Groups_Message" id="Teachers_Groups_Message"
                                    class="form-control" value="Teachers Groups" style="width: 20px; height: 20px;">
                    ...
                    <div class="row mt-3 ml-3 active-state" id="message-second-body-bompa">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="Specific_BOM_Message" id="Specific_BOM_Message"
                                    class="form-control" value="Specific BOM/PA members"
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="BOM_Groups_Message" id="BOM_Groups_Message"
                                    class="form-control" value="BOM/PA Groups" style="width: 20px; height: 20px;">
                    ...
                    <div class="row mt-3 ml-3 active-state" id="message-second-body-staff">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="All_Staff_Message" id="All_Staff_Message"
                                    class="form-control" value="All Staff members" style="width: 20px; height: 20px;">
                                <label class="ml-2" for="All_Staff_Message">All Staff members</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="Specific_Staff_Message" id="Specific_Staff_Message"
                                    class="form-control" value="Specific Staff members"
                                    style="width: 20px; height: 20px;">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <input type="checkbox" name="Staff_Groups_Message" id="Staff_Groups_Message"
                                    class="form-control" value="Staff Groups" style="width: 20px; height: 20px;">
                    ...
                    <div class="row mt-3 mb-3 ml-3 active-state" id="message-second-body-alumni">
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex">
                                <select class="select form-control" id="alumni_category" name="alumni_category"
                                    data-fouc data-placeholder="Graduation Class Category">
                    ...
                    <div class="row active-state ml-1" id="message-second-footer" style="margin-top: -60px;">
                        <div class="col-12" id="message-second-body-category" style="margin-top:-10px;">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="message_type_category" multiple
                                    onchange="selectChange();" name="message_type_category[]" data-fouc
                        ...
                        <div class="col-12 active-state" id="message-second-body-category-detail"
                            style="margin-top:-10px;">
                            <div class="form-group">
                                <label for="message_type_category_detail">Teachers</label>
                                <select class="select form-control" id="message_type_category_detail" multiple
                                    name="message_type_category_detail" data-fouc data-placeholder="Select....">
                                    <option value="">Information</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 text-left mt-3 ml-3">
                            ...
                            &nbsp;
                            <button type="button" class="btn btn-primary" id="next-message-type-btn">Next<i
                                    class="icon-paperplane ml-2"></i></button>
                        </div>
                    </div>
                    <br><br>
                    <h5 class="active-font-state" id="message-final-title"> <span
                            class="badge active-badge-state  rounded-circle text-center"
                            id="message-final-badge">3</span> &nbsp; Final Step</h5>
                    <div class="row mt-3 ml-3 active-state" id="message-final-body">
                        ...
                        <div class="col-6 mt-3" id="message-final-category">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="message_category" name="message_category"
                                    data-fouc data-placeholder="Message Category">
                        ...
                        <div class="row" style="margin-top: -400px;">
                            <div class="col-12 active-state" id="message-final-phone">
                                <div class="card">
                                    ...
                                    <div class="card-footer d-none">
                                        <button class='btn push-right' type="button" data-action='add-email'>Add
                                            email</button>
                                        <button class='btn' type="button" data-action='get-emails-count'>Get emails
                                            count</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="message_content" class="form-control" name="message_content"
                                        rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="text-right text-grey ml-2">
                                    (The school's name shall be appended to the end of each message because the school
                                    does not have a unique Sender ID)
                                </div>
                            </div>
                            <div class="col-12 mt-3">
                                <div class="d-flex">
                                    <input type="checkbox" name="Send_Text_Message" id="Send_Text_Message"
                                        class="form-control" checked value="Send Text Message"
                                        style="width: 20px; height: 20px;">
                    ...
                    <div class="row mt-3 ml-3 active-state" id="message-final-body1">
                        ...
                        <div class="row col-12" style="margin-top:-450px;">
                            <div class="col-md-4">
                                <div class="d-flex">
                                    <input type="radio" name="final_type" id="Final_All_Receiver" class="form-control"
                                        checked value="All Form students" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-4">
                                <div class="d-flex">
                                    <input type="radio" name="final_type" id="Final_Stream_Receiver"
                                        class="form-control" value="Specific Stream" style="width: 20px; height: 20px;">
                                    <label class="ml-2" for="Final_Stream_Receiver">Specific Stream</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex">
                                    <input type="radio" name="final_type" id="Final_Student_Receiver"
                                        class="form-control" value="Specific Student"
                                        style="width: 20px; height: 20px;">
                        ...
                        <div class="row ml-1" style="margin-top:-350px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_a_minus" id="chk_a_minus" class="form-control"
                                        checked value="A-" style="width: 20px; height: 20px;">
                                    <label class="ml-2" for="chk_a_minus"> A-</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_b_plus" id="chk_b_plus" class="form-control"
                                        checked value="B+" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_b_minus" id="chk_b_minus" class="form-control"
                                        checked value="B" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_c_plus" id="chk_c_plus" class="form-control"
                                        checked value="C+" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_c_minus" id="chk_c_minus" class="form-control"
                                        checked value="C-" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_d_plus" id="chk_d_plus" class="form-control"
                                        checked value="D+" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex">
                                    <input type="checkbox" name="chk_d_minus" id="chk_d_minus" class="form-control"
                                        checked value="D-" style="width: 20px; height: 20px;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="optional_message" class="form-control" name="optional_message"
                                        rows="5"
                                        placeholder="Optional message to be sent along with the exam results"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 mt-3">
                                <div class="d-flex">
                                    <input type="checkbox" name="Send_Optional_Message" id="Send_Optional_Message"
                                        class="form-control" value="Send Optional Message"
                                        style="width: 20px; height: 20px;">
                                    <label class="ml-2" for="Send_Optional_Message">Only send the optional message(exam
                                        results won't be sent along)</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @for ($i = 0; $i < count($sms_messages); $i++) <tr>
                                    ...
                                    <td><a href="{{ route('messages.msggroup', $sms_messages[$i]['id']) }}"
                                            class="dropdown-item"><i class="icon-eye"></i></a></td>
                                    </tr>
                                    @endfor
                            </tbody>
                        </table>
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-body text-secondary">
                                ...
                                <p>2 Ensure that the account number you specify in MPESA is exactly as shown above i.e.
                                    SMS3192. if you ignore any letter
                                    or number, the payment will be rejected
                                </p>
                                <p>3 Once you make the payment, Safaricom will notify you that the payment has been made
                                    to Litemore Ltd</p>
                                <br>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row col-12 justify-content-end">
                                            ...
                                            <a class="btn btn-primary" id="message-view-sms"
                                                href="{{ route('main.buy') }}">View SMS Purchases</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
