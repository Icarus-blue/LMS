...
<div class="card">
    ...
    <ul class="nav nav-tabs nav-tabs-highlight cardpos" style="margin-bottom: 0;transform:translateX(-12px);">
        ...
        <li ><a href="#dashboard-pane" class="nav-link active" data-toggle="tab">Manage Events</a></li>
        @else
        <li ><a href="#dashboard-pane" class="nav-link active" data-toggle="tab">Manage Events</a></li>
        <li ><a href="#my-subject-pane" class="nav-link" data-toggle="tab">Newsletters</a></li>
        @endif
    </ul>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <div class="row align-items-center">
                                <input type="radio" name="date_type" id="event_single" class="form-control ml-2 create-radio" checked value="single" style="width: 20px; height: 20px;">
                                <label class="ml-2 mb-0" for="event_single">Single </label>

                                <input type="radio" name="date_type" id="event_range" class="form-control ml-2 create-radio" value="range" style="width: 20px; height: 20px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label for="upi">Event Dates</label>
                            <div class="row align-items-center">
                                <input type="radio" name="date_type" id="edit_event_single" class="form-control ml-2 edit-radio" value="single" style="width: 20px; height: 20px;">
                                <label class="ml-2 mb-0" for="event_single">Single </label>

                                <input type="radio" name="date_type" id="edit_event_range" class="form-control ml-2 edit-radio" value="range" style="width: 20px; height: 20px;">
                                <label class="ml-2 mb-0" for="event_range">Range</label>
                            </div>
