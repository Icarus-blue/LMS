            ...
            @endif
                ...
                <div class="row py-3" style="background: whitesmoke" style="transform:translateX(-40px);">
                    <div class="col-md-4 mr-3" style="margin-left: -20px;">
                        <div class="row">
                            <div class="card col-md-12 mt-2 ml-2">
                                ...
                                <div class="d-flex flex-column ml-3 my-3">
                                    <div class="d-flex flex-row title1">
                                        USERNAME:
                                    </div>
                    ...
                    <div class="col-md-8 m-0" style="text-align: left;">
                        {{-- <span>{{ $message }}</span> --}}
                            ...
                            <div class="card col-12 px-4" style="margin-top:10px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name" class="title1">Name</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="phone" class="title1">Phone Number</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="title1">Personal Email</label>
                                            <input value="{{ $user->email }}" type="text" name="email" id="email" placeholder="####" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="gender">Gender</label>
                                        <select class="select form-control title1" id="gender" name="gender" data-fouc data-placeholder="Choose..">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="tsc_no" class="title1">TSC No.</label>
                                            <input value="{{ $user->tsc_no }}" type="text" name="tsc_no" id="tsc_no" placeholder="####" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nal_id" class="title1">ID Number</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="bio" class="title1">Bio</label>
                                            <textarea class="form-control" style="height: calc(10rem - 48px);">Bio</textarea>
                                        </div>
                                    </div>
    {{--
                                    <div class="col-md-6">
                                ...
                                <div class="text-right">
                                    <button class="btn btn-warning" onclick="showTwoButtonImage(event)" id="edit_button">
                                    <i class="icofont-trash"></i> Cancel
                                    </button>
