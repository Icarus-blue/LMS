            ...
            <div class="tab-pane fade show active" id="dashboard-pane">
                                        ...
                                        <a href="{{ route('teachers.index') }}"  style="color:black">
                                            <div class="py-2 pl-2 bg-white has-bg-image" style="border-radius: 5x;">
                                                <div class="media">
                                                    ...
                                                    <div class="ml-3 align-self-center">
                                                        <p class="mb-0" style="text-align:left;font-weight: 700;font-size:1.2rem">{{ $users->where('user_type_id', 3)->count() }}</p>
                                        ...
                                        <a href="{{ route('students.index') }}"  style="color: black;">
                                            <div class="py-2 pl-2 bg-white has-bg-image" style="border-radius: 5px">
                                                <div class="media">
                                                    ...
                                                    <div class="ml-3 align-self-center">
                                                        <p class="mb-0" style="text-align:left;font-weight: 700;font-size:1.2rem">{{ $users->where('user_type_id', 2)->count() }}</p>
                                        ...
                                        <a href="{{ route('staffs.index') }}"  style="color: black;">
                                            <div class="py-2 pl-2 bg-white has-bg-image" style="border-radius: 5px">
                                                <div class="media">
                                                    ...
                                                    <div class="ml-3 align-self-center">
                                                        <p class="mb-0" style="text-align:left;font-weight: 700;font-size:1.2rem">{{ $users->where('user_type_id', 1)->count() }}</p>
                                        ...
                                        <a href="{{ route('classes.index') }}"  style="color: black;">
                                            <div class="py-2 pl-2 bg-white has-bg-image" style="border-radius: 5px;">
                                                <div class="media">
                                                    ...
                                                    <div class="ml-3 align-self-center">
                                                        <p class="mb-0" style="text-align:left;font-weight: 700;font-size:1.2rem">{{ $stream->count() }}</p>
                ...
                <div class="row" style="margin-top: -10px;">
                    ...
                    <div class="formcard col-md-3 p-2" style="text-align: left;">
                        ...
                        <?php $temp='';intval($val->name)>1?$temp=intval($val->name)-1:'';$temp !=''?$temp="Form ".$temp.' -':''; ?>
                        ...
                        <div class="row">
                            <div class="one-form-pane col-md-6">
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div>
                                        <span style="background:#ccc;font-size:10px;padding:5px;">-0.145 <i class="text-danger">↓</i> </span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <h4 class="font-green mt-1">2.2857</h4>
                                </div>
                            </div>
                            <div class="one-form-pane col-md-6">
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div>
                                        <span  style="background:#ccc;font-size:10px;padding:5px;">-0.145 <span class="text-danger">↓</span></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <h4 class="font-green mt-1">29.26%</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-1 mb-1">
                                <a href="#" class="btn btn-success p-2" style="width: 100%;">View Analysis</a>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="row" style="background: whitesmoke;">
                    @foreach ($all_myclasses as $item)
                        @foreach ($all_forms as $form)
                            @if ($teacher!=null && $item->teacher_id ==$teacher->id && $form->teacher_id == $teacher->id && $form->id == $item->form_id)
                                <div class="card col-md-3 p-2" style="text-align: left;">
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="d-flex justify-content-around">
                                                ...
                                                <div>
                                                    <span style="background:#b7c1d1;font-size:10px;padding:2px;">-0.145 <span class="text-danger">↓</span></span>
                                                </div>
                                            </div>
                                            <h3 class="font-green">2.2857</h3>
                                        </div>
