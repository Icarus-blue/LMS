...
<div class="card">
    <div class="card-body" style="background-color: #F2F2F2;padding-top:0px">
        <ul class="nav nav-tabs nav-tabs-highlight cardpos" style="transform:translateX(-22px);">
            ...
            @else
            <li><a href="#search-student" class="nav-link " data-toggle="tab">Search Student</a></li>
            <li><a href="#new-student" class="nav-link active" data-toggle="tab">Add New Student</a></li>
        ...
        <div class="tab-content tabpos">
            <div class="tab-pane fade" id="search-student">
            ...
            <div class="tab-pane fade  show active" id="new-student" style="background-color: white;padding:30px">
