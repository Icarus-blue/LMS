                                ...
                                <div class="card col-12 ml-2 p-4">
                                    <div class="d-flex flex-column align-items-center welcome-pane">
                                        ...
                                        <div class="my-3 text-center">
                                            <h4><b>{{$teacher->user->name}}</b></h4>
                                            <h5 style="color: #6c757d">{{$teacher->user->email}}</h5>
                                    ...
                                    <div class="d-flex flex-column ml-3 m-1">
                                        {{-- <div class="d-flex flex-column"> --}}
                                            <div class="d-flex flex-row">
                                                <label>Phone: </label> <b style="color: #2ea5de">{{$teacher->user->phone}}</b>
                                            </div>
                                            <div class="row ml-1">
                                        ...
                                        <div style="text-align: right">
                                            {{-- @if(Qs::userIsSuperAdmin()) --}}
                                                <button id="{{ $teacher->id }}" onclick="confirmDelete(this.id)" style="cursor: pointer;border-radius:5px;background:#ff562f;line-height:1.35;font-size:0.925rem"   class="btn-danger mt-3 px-2 py-1 border-0"><i class="icon-trash"></i> &nbsp; Delete</button>
                                                <form method="post" id="item-delete-{{ $teacher->id }}" action="{{ route('teachers.destroy', $teacher->id) }}" class="hidden">@csrf @method('delete')</form>
                                            {{-- @endif --}}
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="card col-12 p-3" style="text-align: left">
                                    <form method="post" action="{{ route('teachers.update', $teacher->id) }}">
                                        @csrf @method('PUT')
                                        <h4><b> Update details for {{ $teacher->user->name }}</b></h4>
