    ...
    <div class="card" style="background-color: whitesmoke">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight cardpos" style="transform:translateX(-2px);">
                ...
                @else
                    <li><a href="#all-classes" class="nav-link active" data-toggle="tab"><i class="icofont-settings"></i> Manage Teachers</a></li>
                    <li><a href="#new-user" class="nav-link" data-toggle="tab">+ Add New Teacher</a></li>
                    <li><a href="#all-group" class="nav-link" data-toggle="tab"><i class="icofont-users"></i> Teachers' Groups</a></li>
                @endif
                ...
                <div class="tab-pane fade show active" id="all-classes">
                    <div class="basic">
                        <div class="py-1 pb-0 d-flex flex-row align-items-center" style="background-color: white">
                            <div class="w-100 pl-2" style="text-align: left"><h4 style="font-weight: 700;font-size:1.2857rem; margin: 5px;">Teachers</h4></div>
                            <div class="w-100"></div>
                            <div class="input-group flex-shrink-1" style="height: 30px;">
                                ...
                                <span class="input-group-append">
                                    ...
                                    <button class="btn btn-outline-secondary border-start-0 border rounded-pill ms-n3 mx-2" style="background-color: #132A4E;color:white;border-radius:5px;" onclick="showPrint()" type="button">
                                ...
                                <div class="col-md-3" id="item{{ $num++ }}" aria-label="{{ str_replace(' ', '', $teacher->user->name) }}" >
                                    <div class="card my-2">
                                        ...
                                        <div class="d-flex flex-column align-items-center welcome-pane">
                                            ...
                                            <img  style="border-radius:100%;" src="/{{ $teacher->user->photo_by }}/{{  $teacher->user->photo }}" width="150" height="150"/>
                                            <div class="person" style="transform: translateY(-20px)">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    @else
                                                        @if(Qs::userIsTeamSA())
                                                        <div class="rounded-circle mr-1" style="border-radius: 50%;padding:10px;background-color:green;">
                                                            <a href="{{ route('teachers.edit', $teacher->id) }}" class="dropdown-item p-0 edit" data-toggle="tooltip" data-placement="bottom" title="Edit"></a>
                                                        </div>
                        ...
                        <div class="row">
                            <div class="form-check m-2">
                                <label class="form-check-label">
                                  <input type="radio" id="select_by_key" class="form-check-input" name="optradio" checked>Key in teacher detail
                                </label>
                            </div>
                            <div class="form-check m-2">
                                <label class="form-check-label">
                                  <input type="radio" id="select_by_file" class="form-check-input" name="optradio">Upload teachers from a spreadsheet
                                </label>
                            </div>
                        </div>
                        <div class="card-body">
