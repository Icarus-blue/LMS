        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight cardpos" style="transform:translateX(-2px);">
                @if ($types=="student" || $types=="teacher" || $types=="staff")
                    <li ><a href="#all-classes" class="nav-link active" data-toggle="tab">View Staff</a></li>
                @else
                    <li ><a href="#all-classes" class="nav-link active" data-toggle="tab"><i class="icofont-gear"></i> Manage Staff</a></li>
                    <li ><a href="#new-user" class="nav-link" data-toggle="tab">+ Add Staff</a></li>
                    <li ><a href="#all-group" class="nav-link" data-toggle="tab"><i class="icofont-group"></i> Staff Groups</a></li>
                @endif
            ...
            <div class="tab-content tabpos">
                <div class="tab-pane fade show active" id="all-classes">
                    <div class="basic">
                        <div class="py-1 d-flex flex-row" style="background-color: white">
                            <div class="w-100 pl-2" style="text-align: left"><h4 style="font-weight:700;font-size:1.2857rem">Staff</h4></div>
                            <div class="w-100"></div>
                        ...
                        <div class="row mt-1" id="staff_card">
                            <?php $num=0; ?>
                                ...
                                <div class="col-md-3" id="item{{ $num++ }}" aria-label="{{ str_replace(' ', '', $staff->user->name) }}">
                                    <div class="card my-2" style="border-radius: 10px;">
                                        ...
                                        <div class="d-flex flex-column align-items-center welcome-pane">
                                            <img class="rounded-circle" src="/{{ $staff->user->photo_by }}/{{ $staff->user->photo }}" width="150" height="150"/>
                                            <div class="person" style="transform: translateY(-20px)">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="rounded-circle " style="border-radius: 50%;padding:10px;background-color:green;">
                                                        <a href="{{ route('staffs.edit', $staff->id) }}" class="dropdown-item p-0 edit" data-toggle="tooltip" data-placement="bottom" title="Edit" ></a>
                                            ...
                                            <div class="my-1 text-center">
                                                <h3 style="font-weight: 400">{{$staff->user->name}}</h3>
                                                <h6>{{$staff->user->email}}</h6>
                                                <h6 style="color:#2ea5de">{{$staff->user->phone}}</>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="print active-state" style="background: white">
                        ...
                        <div class="d-flex flex-row mt-2 py-4" style="background: whitesmoke">
                            <div class="w-100" style="text-align:left">
                                <button class="btn btn-seconday" style="background: #b7c1d1;border-radius:5px;" onclick="showManageTeacher()">Close Print format</button>
                            </div>
                ...
                <div class="tab-pane fade " style="text-align: left;" id="new-user">
                    <div class="card p-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <input type="radio" id="select_by_key" name="staff_member" value="key" checked>
                              <label for="select_by_key">Key in Staff member details</label>
                            </div>
                            <div class="col-md-6">
                              <input type="radio" id="select_by_file" name="staff_member" value="key">
                              <label for="select_by_file">Upload Staff members from a spreadsheet</label>
                            </div>
                        </div>
                        <div class="card-body">
                            <form class="select_key" id="create_staff_form" method="post" action="{{ route('staffs.store') }}">
                                @csrf
                                {{-- <h6>staff Data</h6> --}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('full_name') }}" type="text" name="full_name" id="full_name" placeholder="Full Name" class="form-control">
                                            <span style="color: red;" id="staff_name_helper"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('email') }}" type="text" name="email" id="email" placeholder="Email" class="form-control">
                                            <span style="color: red;" id="staff_email_helper"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('phone_number') }}" class="form-control" placeholder="07## ### ###" name="phone_number" id="phone_number" type="text">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('national_id_no') }}" type="text" name="national_id_no" id="national_id_no" placeholder="####" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary" id="create-staff-btn">Submit form <i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                            <form class="select_file active-state" action="{{ route('staff_upload') }}" method="post">
                                @csrf
                                <div class="row">
                                    <a href="./download/Upload Staff - Template.xlsx" download>Download <i class="icofont-download"></i></a>
                                       &nbsp;&nbsp;and fill the template then upload it below. (Please leave the column headers intact)
                                </div>
                                <div class="row">
                                    <input type="file" name="file_upload" id="file_upload" onchange="uploadFile_onChange(this, 3);">
                                </div>
