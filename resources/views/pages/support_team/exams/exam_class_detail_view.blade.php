        ...
        <form action="{{ route('exam_class_score') }}" method="post">
            ...
            <div class="row align-items-center ml-1">
                ...
                <div class="col-6 text-right pt-2">
                    <button type="submit" class="btn btn-success" id="exam_class_publish">Publish</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
document.getElementById('exam_class_publish').addEventListener('click', function(){
    Swal.fire({
                title: "Are you sure?",
                ...
                if(result.isConfirmed) {
                    ...
                    'The subject results have been successfully published',
                    'success'
                    )
                }
        });
