    ...
    <div class="card-body" style="background-color: white;">
        ...
        <div class="row align-items-center ml-1">
            ...
            <div class="col-6 text-right pt-2">
                ...
                <button type="button" onclick="publish_mark()" class="btn btn-success" style="font-family: 'Times New Roman', Times, serif;font-size:16px">Publish</button>
...
<!-- <div class="card active-state" id="download"  style="background: whitesmoke">
    <div class="card-body">
        <div class="print">
            <div class="d-flex flex-row mt-2 py-4 justify-content-end">
                <div class="w-100" style="text-align:left">
                    <button class="btn btn-seconday" onclick="back(event)"><-Back</button>
                </div>
                <div class="flex-shrink-1 ml-2">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <button class="dropdown-item" id="btnPrint" onclick="fnPrintReport(event);"> Pdf</button>
                            <a class="dropdown-item" id="btnExport" onclick="fnExcelReport(event);"> Spreadsheet</a>
                        </div>
                    </div>
                </div>
            </div>
            <div id="printView" style="background:white;padding:0 160px;">
                <div class="d-flex align-items-center justify-content-between mt-2 p-4">
                    ...
                    <div class="text-center">
                        ...
                        <h4>{{ $exam->name }}, Term {{ $exam->term }}, {{ $exam->year }}</h4>
                        <h4>Form{{ $class_subject->my_class->form->name }} {{ $class_subject->my_class->stream }}  {{ $class_subject->subject->title  }}</h4>
                        - Mark List
                    </div>
                    <div class="text-center">
                ...
                <div class="d-flex align-items-center justify-content-between flex-row p-4" style="background-color: white">
                    <table id="printDatatable" class="table table-striped">
                        ...
                        <thead style="text-align: center">
                            <tr>
                                <th colspan="8">Form{{ $class_subject->my_class->form->name }} {{ $class_subject->my_class->stream }}  {{ $class_subject->subject->title  }} - {{ $exam->name }}, Term {{ $exam->term }}, {{ $exam->year }}</th>
                            </tr>
                            <tr>
                                <th style="width:5%">#</th>
                                <th style="width:10%;">ADMNO</th>
                                ...
                                @foreach ($marks as $mark)
                                    @if (($mark->student_id == $class_subject->my_class->students[$i]->id)&&($mark->pos>0))
                                        <tr style="line-height:10px;">
                                            ...
                                            <td>{{ $class_subject->my_class->stream }}</td>
                                            <td>{{ $mark->pos }}</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
