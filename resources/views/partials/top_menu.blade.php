<div class="navbar navbar-expand-md navbar-dark" style="position: fixed;z-index:100;width:100%;height: 70px;font-family:'Times New Roman', Times, serif">

    <div class="navbar-brand" style="min-width: 200px;background-color:#263238;padding:20px;padding-top: 10px;transform:translateX(-20px)">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <div class="mr-5" style="height:25px">
            <a href="{{ route('dashboard') }}" class="d-inline-block">
            {{-- <h4 class="text-bold text-white">{{ Qs::getSystemName() }}</h4> --}}
            <h4 class="text-bold text-success" style="font-size: 1.1428571429rem!important;">{{ Auth::user()->school_name }}</h4>
        ...
        &nbsp;
        <div class="input-group" style="width: 50px;height: 34.61px;">
            {{-- <input type="text" class="form-control" placeholder="Search Student"> --}}
            <div class="input-group-append" style="background-color:#324148;border-radius:5px; border:1px solid white;height: 34.61px;">
        ...
        <div style="background-color:white;padding:5px;border-radius:5px;transform:translateX(-12px);">
            <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown dropdown-user">
                <div class="d-flex flex-row">
                    ...
                    <a class="pl-2" style="cursor: pointer" data-toggle="dropdown">
                        <img style="width: 46px; height:46px;" src="/sign_number/{{Auth::user()->photo}}" class="rounded-circle" alt="photo">
